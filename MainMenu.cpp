...
void Main_menu::show_menu(sf::RenderWindow& window) {
	...
	helpBtn.init("Help", ResourcesMan::getFont("primary"), 60, { 800, 100 }, { xPos, yPos + 140.f }, sf::Color(110, 120, 110), sf::Color::White);
	quitBtn.init("Exit", ResourcesMan::getFont("primary"), 60, { 800, 100 }, { xPos, yPos + 280.f }, sf::Color(110, 120, 110), sf::Color::White);
